          ...
          <Section bg="light" className="py-3 profile mb-4">
            <div className="profile-editor">
              <div className="img-holder">
                ...
                <AvatarUploader
                  url={`https://yvoijqsuhd.execute-api.us-east-1.amazonaws.com/development/slickcomp-images/academy/${uuid}.png`}
                  onDone={loadData}
                />
              </div>
              {
                <Link className="edit-profile" to={`/dashboard/academy/edit/`}>
