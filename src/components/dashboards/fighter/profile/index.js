...
export const Profile = ({ academyId, userId, uuid }) => {
                ...
                <div className="text">
                  ...
                  <ul className="sub-items">
                    ...
                    {academyData.belt && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.belt')}: {academyData.belt}
                        </span>
                      </li>
                    )}
                    {academyData.weight && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.weight')}: {academyData.weight}
                        </span>
                      </li>
                    )}
                    {academyData.academyName && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.academy')}: {academyData.academyName}
                        </span>
                      </li>
                    )}
                  </ul>
