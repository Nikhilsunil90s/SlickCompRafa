          ...
          <Section bg="light" className="py-3 profile mb-4">
            <div className="profile-editor">
              <div className="img-holder">
                <Avatar src={profileData.avatarUrl || team3} />
                {/* <AvatarUploader
                  url={`https://yvoijqsuhd.execute-api.us-east-1.amazonaws.com/development/slickcomp-images/user/${uuid}.png`}
                  onDone={loadData}
                /> */}
                {/* <Link
            ...
            <div className="profile-details">
              <header className="profile-header">
                <div className="text">
                  {profileData.name && <h5>{profileData.name}</h5>}
                  <ul className="sub-items">
                    {profileData.createTime && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.memberSince')}:{' '}
                          {moment(profileData.createTime).format('DD/MM/YYYY')}
                        </span>
                      </li>
                    )}
                    {profileData.age && (
                    ...
                    {profileData.belt && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.belt')}: {profileData.belt}
                        </span>
                      </li>
                    )}
                    {profileData.weight && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.weight')}: {profileData.weight}
                        </span>
                      </li>
                    )}
                    {profileData.academyName && (
                      <li>
                        <span className="badge rounded-pill badge-soft-primary">
                          {t('profile.academy')}: {profileData.academyName}
                        </span>
                      </li>
                    )}
                  </ul>
